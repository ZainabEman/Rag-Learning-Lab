...
Goal
----
Evaluating trajectories, not just final answers: step count, tool choice, redundant retrievals, cost.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Agentic RAG Evaluation.")
