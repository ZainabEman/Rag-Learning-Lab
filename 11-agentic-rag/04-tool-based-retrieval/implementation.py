...
Goal
----
Exposing multiple retrievers (vector, SQL, web, API) as tools and letting the model choose.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Tool-Based Retrieval.")
