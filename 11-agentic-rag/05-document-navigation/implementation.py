...
Goal
----
Agents that traverse structure - table of contents, sections, links - instead of flat top-k.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Document Navigation.")
