...
Goal
----
Splitting planner, retriever, critic and writer roles; where coordination cost exceeds the benefit.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Multi-Agent RAG.")
