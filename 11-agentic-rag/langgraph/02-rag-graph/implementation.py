...
Goal
----
Rebuilding a linear RAG pipeline as an explicit graph, then adding a grading branch.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying RAG as a Graph.")
