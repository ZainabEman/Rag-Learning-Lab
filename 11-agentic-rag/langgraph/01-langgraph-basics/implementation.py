...
Goal
----
State, nodes, edges, conditional edges and checkpointing - the minimum needed to build a RAG graph.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying LangGraph Basics.")
