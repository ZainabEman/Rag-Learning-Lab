...
Goal
----
Getting answerable information out of figures - description, data extraction, or page-image retrieval.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Charts.")
