...
Goal
----
Reading order, columns, figures and captions; why naive text extraction destroys meaning.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying PDF Layout Understanding.")
