...
Goal
----
Detecting bad retrievals at runtime and repairing them (re-query, expand, fall back).
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Corrective Retrieval.")
