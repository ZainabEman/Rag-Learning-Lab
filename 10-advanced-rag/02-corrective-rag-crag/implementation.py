...
Goal
----
Grading retrieved documents and falling back (e.g. to web search) when they are insufficient.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Corrective RAG (CRAG).")
