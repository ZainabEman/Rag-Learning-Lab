...
Goal
----
Hostile content in the corpus: hidden text, invisible characters, adversarial formatting.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Malicious Documents.")
