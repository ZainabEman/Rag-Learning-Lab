...
Goal
----
Instructions hidden inside retrieved documents - the RAG-specific variant.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Indirect Prompt Injection.")
