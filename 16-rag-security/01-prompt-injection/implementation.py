...
Goal
----
Instructions in user input overriding system intent; why input filtering alone is not a fix.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Prompt Injection.")
