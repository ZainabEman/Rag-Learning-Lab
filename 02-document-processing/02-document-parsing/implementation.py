...
Goal
----
Extracting structure - headings, sections, tables, code blocks - not just a flat string of characters.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Document Parsing.")
