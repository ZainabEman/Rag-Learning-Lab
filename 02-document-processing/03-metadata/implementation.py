...
Goal
----
What metadata to attach at ingestion (source, page, section, timestamp, permissions) and how it is used later for filtering and citation.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Metadata.")
