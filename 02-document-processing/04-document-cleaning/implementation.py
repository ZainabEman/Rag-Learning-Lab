...
Goal
----
Removing headers/footers, boilerplate, broken whitespace and artifacts; measuring what cleaning does to retrieval quality.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Document Cleaning.")
