...
| --- | --- | --- | --- |
| 01 | [Document Loading](01-document-loading/) | Loading PDF, HTML, DOCX, Markdown, CSV and plain text into a common document representation. | `not started` |
...
| 03 | [Metadata](03-metadata/) | What metadata to attach at ingestion (source, page, section, timestamp, permissions) and how it is used later for filtering and citation. | `not started` |
