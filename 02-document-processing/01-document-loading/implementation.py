...
Goal
----
Loading PDF, HTML, DOCX, Markdown, CSV and plain text into a common document representation.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Document Loading.")
