"""
SQL RAG
Section: Specialized RAG

Goal
----
Schema retrieval, text-to-SQL, execution and grounding answers in query results.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying SQL RAG.")
