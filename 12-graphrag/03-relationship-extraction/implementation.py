...
Goal
----
Extracting typed relations between entities with evidence pointers back to source chunks.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Relationship Extraction.")
