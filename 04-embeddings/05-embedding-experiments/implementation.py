...
Goal
----
Probing embedding behaviour: negation, synonyms, numbers, code, multilingual text, chunk length effects.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Embedding Experiments.")
