...
Goal
----
What embedding similarity captures (topic, paraphrase) and what it misses (negation, numbers, entities).
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Semantic Similarity.")
