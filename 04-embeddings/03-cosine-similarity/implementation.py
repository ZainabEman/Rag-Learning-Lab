...
Goal
----
Cosine, dot product and Euclidean distance from scratch with numpy; why normalisation matters.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Cosine Similarity.")
