...
Goal
----
Comparing local sentence-transformers vs hosted APIs on dimension, cost, latency, context length and domain fit.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Embedding Models.")
