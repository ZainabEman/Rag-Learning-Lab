...
Goal
----
The baseline retriever end to end: embed query, search, return chunks with scores and sources.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Semantic Retrieval.")
