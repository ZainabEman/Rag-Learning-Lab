...
Goal
----
Why a second-stage scorer beats first-stage similarity, and the retrieve-many/rerank-few pattern.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Reranking Basics.")
