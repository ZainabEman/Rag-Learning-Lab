...
Goal
----
Filtering or shortening retrieved chunks against the query before they reach the prompt.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Contextual Compression.")
