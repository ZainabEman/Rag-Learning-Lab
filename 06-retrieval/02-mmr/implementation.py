...
Goal
----
Trading relevance against diversity to stop the top-k being five copies of the same paragraph.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying MMR (Maximal Marginal Relevance).")
