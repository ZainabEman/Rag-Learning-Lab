...
> Section: [RAG Evaluation](../README.md) | Status: `not started`

## Scope

Separating retrieval quality from generation quality; offline vs online; what a good test set looks like.
...
| [experiment.md](experiment.md) | Written comparison - no runnable experiment for this topic |
