...
Goal
----
Building a labelled query/relevant-document set and scoring a retriever against it.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Retrieval Evaluation.")
