...
Goal
----
Building small golden sets by hand and generating synthetic ones; keeping them honest.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Evaluation Datasets.")
