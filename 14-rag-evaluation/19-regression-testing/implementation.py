...
Goal
----
Locking in a baseline so a 'small improvement' cannot silently break retrieval.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Regression Testing.")
