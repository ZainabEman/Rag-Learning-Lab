...
Goal
----
Why overlap exists, what it costs in storage and duplication, and how much is actually useful.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Chunk Overlap.")
