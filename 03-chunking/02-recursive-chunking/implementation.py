...
Goal
----
Splitting on a hierarchy of separators so paragraphs and sentences survive where possible.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Recursive Chunking.")
