...
Goal
----
Character and token based splitting; why it is the baseline and where it breaks semantic units.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Fixed-Size Chunking.")
