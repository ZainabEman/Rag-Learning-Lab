...
Goal
----
The trade-off between retrieval precision (small chunks) and context sufficiency (large chunks).
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Chunk Size.")
