...
Goal
----
Semantic, structure-aware, sentence-window and document-specific strategies compared on the same corpus.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Chunking Strategies.")
