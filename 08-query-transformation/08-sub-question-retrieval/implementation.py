...
Goal
----
Running retrieval per sub-question and synthesising a single grounded answer.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Sub-Question Retrieval.")
