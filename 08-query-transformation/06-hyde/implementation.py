...
Goal
----
Embedding a generated hypothetical answer instead of the raw question; when this helps and when it hurts.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying HyDE (Hypothetical Document Embeddings).")
