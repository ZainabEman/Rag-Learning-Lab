...
Goal
----
Resolving pronouns and implicit context in follow-up turns into standalone queries.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Conversational Query Rewriting.")
