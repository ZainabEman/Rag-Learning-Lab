"""
LangSmith Setup
Section: LangSmith Examples

Goal
----
Environment variables, projects and getting a first trace to appear. Never commit the API key.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying LangSmith Setup.")
