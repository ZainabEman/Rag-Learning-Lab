...
Section: RAG Observability

Goal
----
Triaging bad answers into retrieval, ranking, context or generation failures.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Failed Retrieval Analysis.")
