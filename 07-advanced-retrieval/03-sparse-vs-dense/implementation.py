...
Goal
----
Where lexical matching wins (rare terms, IDs, exact phrases) and where dense wins (paraphrase, intent).
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Sparse vs Dense Retrieval.")
