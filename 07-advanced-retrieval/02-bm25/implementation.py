...
Goal
----
The Okapi BM25 scoring function implemented by hand, then via rank_bm25; the role of k1 and b.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying BM25.")
