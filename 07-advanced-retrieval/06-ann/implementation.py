...
Goal
----
The recall/latency trade-off: why exact search stops being viable and what 'approximate' costs you.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Approximate Nearest Neighbour.")
