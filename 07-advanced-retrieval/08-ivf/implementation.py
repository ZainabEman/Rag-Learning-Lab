...
Goal
----
Clustering vectors into cells and probing a subset; nlist/nprobe and their effect on recall.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying IVF (Inverted File Index).")
