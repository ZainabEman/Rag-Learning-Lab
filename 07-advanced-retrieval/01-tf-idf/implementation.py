...
Goal
----
Term weighting from scratch: term frequency, inverse document frequency, and the vector space model.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying TF-IDF.")
