...
Goal
----
Hierarchical navigable small world graphs: layers, M, ef_construction, ef_search - and what each does to recall.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying HNSW.")
