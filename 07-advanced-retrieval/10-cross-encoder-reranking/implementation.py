...
Goal
----
Joint query-document encoding: why it is more accurate than bi-encoders and why it cannot scale to the whole corpus.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Cross-Encoder Reranking.")
