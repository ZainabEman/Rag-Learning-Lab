...
Goal
----
Rank-based fusion that avoids score normalisation entirely; implementing RRF from the formula.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Reciprocal Rank Fusion.")
