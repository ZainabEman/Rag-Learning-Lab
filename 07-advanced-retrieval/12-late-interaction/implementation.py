...
Goal
----
The general idea behind ColBERT-style models compared to early interaction (cross-encoders) and no interaction (bi-encoders).
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Late Interaction.")
