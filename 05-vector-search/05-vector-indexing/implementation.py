...
Goal
----
Flat vs approximate indexes: what an index build actually does and what it costs.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Vector Indexing.")
