...
Goal
----
How k affects recall, precision, prompt size and cost; finding a sensible default for a corpus.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Top-K.")
