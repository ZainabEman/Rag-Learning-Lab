...
Goal
----
Brute-force search from scratch, then the same query through Chroma/FAISS; verifying the results match.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Similarity Search.")
