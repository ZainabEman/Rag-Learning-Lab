...
Goal
----
Pre-filter vs post-filter, and how filtering interacts with approximate indexes.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Metadata Filtering.")
