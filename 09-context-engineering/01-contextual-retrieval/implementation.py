...
Goal
----
Prepending chunk-level context (document/section summary) before embedding to fix orphaned chunks.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Contextual Retrieval.")
