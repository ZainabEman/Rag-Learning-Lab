...
Goal
----
Allocating a fixed context window across system prompt, history, retrieved context and answer.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Token Budgeting.")
