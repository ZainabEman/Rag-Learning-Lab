...
Goal
----
Indexing small chunks for precision but returning the parent block for context.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Parent Document Retrieval.")
