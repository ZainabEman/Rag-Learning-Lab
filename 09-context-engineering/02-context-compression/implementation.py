...
Goal
----
Extractive and abstractive compression of retrieved context under a token budget.
...
def main() -> None:
    ...
    raise NotImplementedError("TODO: implement while studying Context Compression.")
